...
use crate::{
    ActiveConnection, Connection, DeviceCapabilities, DeviceState, DeviceStateReason, DeviceType,
    DhcpConfig, IPConfig, Object, RemoteConnection,
};
...
pub trait DeviceExt: 'static {
    ...
    /// ## `flags`
    /// the flags argument. See [`DeviceReapplyFlags`][crate::DeviceReapplyFlags].
    /// ## `cancellable`
    /// a [`gio::Cancellable`][crate::gio::Cancellable], or [`None`]
    ///
    /// # Returns
