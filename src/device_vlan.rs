...
impl DeviceVlan {
    ...
    pub fn connect_property_hw_address_notify<F: Fn(&DeviceVlan) + 'static>(
        &self,
        f: F,
    ) -> SignalHandlerId {
        unsafe extern "C" fn notify_hw_address_trampoline<F: Fn(&DeviceVlan) + 'static>(
            this: *mut nm_sys::NMDeviceVlan,
            _param_spec: glib_sys::gpointer,
            f: glib_sys::gpointer,
        ) {
    ...
    pub fn connect_property_vlan_id_notify<F: Fn(&DeviceVlan) + 'static>(
        ...
        unsafe {
            ...
            connect_raw(
                ...
                Some(transmute(notify_vlan_id_trampoline::<F> as usize)),
                Box_::into_raw(f),
            )
        }
    }
