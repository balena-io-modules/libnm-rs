...
impl DeviceBond {
    ...
    /// Gets the hardware (MAC) address of the [`DeviceBond`][crate::DeviceBond]
    ///
    ...
    pub fn hw_address(&self) -> Option<glib::GString> {
        unsafe { from_glib_none(ffi::nm_device_bond_get_hw_address(self.to_glib_none().0)) }
    }
    ...
    pub fn slaves(&self) -> Vec<Device> {
        unsafe {
            FromGlibPtrContainer::from_glib_none(ffi::nm_device_bond_get_slaves(
                self.to_glib_none().0,
            ))
        }
    }
