...
use crate::{Connection, SecretAgentCapabilities, SecretAgentGetSecretsFlags};
use glib::{
    prelude::*,
...
glib::wrapper! {
    ...
    /// NetworkManager, and [`SecretAgentOldExt::enable()`][crate::prelude::SecretAgentOldExt::enable()] or
    /// [`SecretAgentOldExt::register_async()`][crate::prelude::SecretAgentOldExt::register_async()] must be called to register it.
    ///
    /// Calling [`SecretAgentOldExt::enable()`][crate::prelude::SecretAgentOldExt::enable()] has the same effect as setting this
    /// property.
    ///
    ...
    ///
    /// #### `dbus-connection`
    ///  The [`gio::DBusConnection`][crate::gio::DBusConnection] used by the instance. You may either set this
    /// as construct-only property, or otherwise [`SecretAgentOld`][crate::SecretAgentOld] will choose
    ...
    /// # Implements
    ///
    /// [`SecretAgentOldExt`][trait@crate::prelude::SecretAgentOldExt], [`trait@glib::ObjectExt`]
