...
glib::wrapper! {
    ...
    /// It uses `GMainContext` and [`gio::DBusConnection`][crate::gio::DBusConnection] for that and registers to
    /// D-Bus signals. That means, when iterating the associated `GMainContext`,
    /// D-Bus signals gets processed and the [`Client`][crate::Client] instance updates and
    /// emits [`glib::Object`][crate::glib::Object] signals.
    ///
    /// ## Properties
    ///
    ///
    /// #### `activating-connection`
    ///  The [`ActiveConnection`][crate::ActiveConnection] of the activating connection that is
    /// likely to become the new [`primary-connection`][struct@crate::Client#primary-connection].
    ///
    /// Readable
    ///
    ///
    ...
    ///
    /// #### `dbus-connection`
    ///  The [`gio::DBusConnection`][crate::gio::DBusConnection] to use.
    ///
    ...
    /// of [`DnsEntry`][crate::DnsEntry] objects.
    ///
    /// Readable
    ///
    ///
    ...
    /// modified by calling [`Client::save_hostname()`][crate::Client::save_hostname()].
    ///
    /// Readable
    ///
    ///
    ...
    ///
    /// #### `primary-connection`
    ///  The [`ActiveConnection`][crate::ActiveConnection] of the device with the default route;
    /// see [`Client::primary_connection()`][crate::Client::primary_connection()] for more details.
    ///
    /// Readable
    ///
    ///
    /// #### `radio-flags`
    ///  Flags for radio interfaces. See [`RadioFlags`][crate::RadioFlags].
    ///
    /// Readable
    ///
    ///
...
impl Client {
    ...
    /// [`ActiveConnection`][crate::ActiveConnection] object (in particular, [`state`][struct@crate::ActiveConnection#state]) to
    ...
    /// [`primary-connection`][struct@crate::Client#primary-connection] upon successful activation.
    ///
    /// # Returns
    ///
