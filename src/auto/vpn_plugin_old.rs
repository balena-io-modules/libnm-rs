...
glib_wrapper! {
    ...
    match fn {
        get_type => || ffi::nm_vpn_plugin_old_get_type(),
    }
}
...
impl<O: IsA<VpnPluginOld> + IsA<glib::object::Object>> VpnPluginOldExt for O {
    fn disconnect(&self) -> Result<(), Error> {
        unsafe {
    ...
    fn failure(&self, reason: VpnPluginFailure) {
        unsafe {
            ffi::nm_vpn_plugin_old_failure(self.to_glib_none().0, reason.to_glib());
        }
    }
    ...
    fn set_state(&self, state: VpnServiceState) {
        unsafe {
            ffi::nm_vpn_plugin_old_set_state(self.to_glib_none().0, state.to_glib());
        }
    }
    ...
    P: IsA<VpnPluginOld>,
{
    ...
    f(
        &VpnPluginOld::from_glib_borrow(this).downcast_unchecked(),
...
unsafe extern "C" fn quit_trampoline<P>(this: *mut ffi::NMVpnPluginOld, f: glib_ffi::gpointer)
where
    P: IsA<VpnPluginOld>,
{
    let f: &&(Fn(&P) + 'static) = transmute(f);
    f(&VpnPluginOld::from_glib_borrow(this).downcast_unchecked())
}
