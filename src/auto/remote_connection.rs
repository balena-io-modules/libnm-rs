...
pub trait RemoteConnectionExt: Sized {
    ...
    #[cfg(feature = "futures")]
    fn commit_changes_async_future(&self, save_to_disk: bool) -> Box_<futures_core::Future<Item = (Self, ()), Error = (Self, Error)>>;
    ...
    #[cfg(feature = "futures")]
    fn get_secrets_async_future(&self, setting_name: &str) -> Box_<futures_core::Future<Item = (Self, glib::Variant), Error = (Self, Error)>>;
    ...
    #[cfg(feature = "futures")]
    fn save_async_future(&self) -> Box_<futures_core::Future<Item = (Self, ()), Error = (Self, Error)>>;
...
impl<O: IsA<RemoteConnection> + IsA<glib::object::Object> + Clone + 'static> RemoteConnectionExt for O {
    fn commit_changes<'a, P: Into<Option<&'a gio::Cancellable>>>(&self, save_to_disk: bool, cancellable: P) -> Result<(), Error> {
