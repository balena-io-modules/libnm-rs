...
impl Client {
    ...
    pub fn activate_connection_async<'a, 'b, 'c, 'd, P: IsA<Connection> + 'a, Q: Into<Option<&'a P>>, R: IsA<Device> + 'b, S: Into<Option<&'b R>>, T: Into<Option<&'c str>>, U: Into<Option<&'d gio::Cancellable>>, V: FnOnce(Result<ActiveConnection, Error>) + Send + 'static>(&self, connection: Q, device: S, specific_object: T, cancellable: U, callback: V) {
    ...
    #[cfg(feature = "futures")]
    pub fn activate_connection_async_future<'a, 'b, 'c, P: IsA<Connection> + Clone + 'static, Q: Into<Option<&'a P>>, R: IsA<Device> + Clone + 'static, S: Into<Option<&'b R>>, T: Into<Option<&'c str>>>(&self, connection: Q, device: S, specific_object: T) -> Box_<futures_core::Future<Item = (Self, ActiveConnection), Error = (Self, Error)>> {
        use gio::GioFuture;
    ...
    pub fn add_and_activate_connection_async<'a, 'b, 'c, P: IsA<Connection> + 'a, Q: Into<Option<&'a P>>, R: IsA<Device>, S: Into<Option<&'b str>>, T: Into<Option<&'c gio::Cancellable>>, U: FnOnce(Result<ActiveConnection, Error>) + Send + 'static>(&self, partial: Q, device: &R, specific_object: S, cancellable: T, callback: U) {
    ...
    #[cfg(feature = "futures")]
    pub fn add_and_activate_connection_async_future<'a, 'b, P: IsA<Connection> + Clone + 'static, Q: Into<Option<&'a P>>, R: IsA<Device> + Clone + 'static, S: Into<Option<&'b str>>>(&self, partial: Q, device: &R, specific_object: S) -> Box_<futures_core::Future<Item = (Self, ActiveConnection), Error = (Self, Error)>> {
        use gio::GioFuture;
        use send_cell::SendCell;
    ...
    pub fn add_connection_async<'a, P: IsA<Connection>, Q: Into<Option<&'a gio::Cancellable>>, R: FnOnce(Result<RemoteConnection, Error>) + Send + 'static>(&self, connection: &P, save_to_disk: bool, cancellable: Q, callback: R) {
        let cancellable = cancellable.into();
        let cancellable = cancellable.to_glib_none();
    ...
    #[cfg(feature = "futures")]
    pub fn add_connection_async_future<P: IsA<Connection> + Clone + 'static>(&self, connection: &P, save_to_disk: bool) -> Box_<futures_core::Future<Item = (Self, RemoteConnection), Error = (Self, Error)>> {
        use gio::GioFuture;
        use send_cell::SendCell;
    ...
    pub fn check_connectivity<'a, P: Into<Option<&'a gio::Cancellable>>>(&self, cancellable: P) -> Result<ConnectivityState, Error> {
        let cancellable = cancellable.into();
        let cancellable = cancellable.to_glib_none();
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn check_connectivity_async<'a, P: Into<Option<&'a gio::Cancellable>>, Q: FnOnce(Result<ConnectivityState, Error>) + Send + 'static>(&self, cancellable: P, callback: Q) {
        let cancellable = cancellable.into();
        let cancellable = cancellable.to_glib_none();
    ...
    #[cfg(feature = "futures")]
    pub fn check_connectivity_async_future(&self) -> Box_<futures_core::Future<Item = (Self, ConnectivityState), Error = (Self, Error)>> {
        use gio::GioFuture;
        use send_cell::SendCell;
    ...
    pub fn deactivate_connection<'a, P: IsA<ActiveConnection>, Q: Into<Option<&'a gio::Cancellable>>>(&self, active: &P, cancellable: Q) -> Result<(), Error> {
        let cancellable = cancellable.into();
        let cancellable = cancellable.to_glib_none();
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn deactivate_connection_async<'a, P: IsA<ActiveConnection>, Q: Into<Option<&'a gio::Cancellable>>, R: FnOnce(Result<(), Error>) + Send + 'static>(&self, active: &P, cancellable: Q, callback: R) {
        let cancellable = cancellable.into();
        let cancellable = cancellable.to_glib_none();
        let user_data: Box<Box<R>> = Box::new(Box::new(callback));
    ...
    #[cfg(feature = "futures")]
    pub fn deactivate_connection_async_future<P: IsA<ActiveConnection> + Clone + 'static>(&self, active: &P) -> Box_<futures_core::Future<Item = (Self, ()), Error = (Self, Error)>> {
        use gio::GioFuture;
        use send_cell::SendCell;
    ...
    pub fn reload_connections<'a, P: Into<Option<&'a gio::Cancellable>>>(&self, cancellable: P) -> Result<(), Error> {
        let cancellable = cancellable.into();
        let cancellable = cancellable.to_glib_none();
        unsafe {
            let mut error = ptr::null_mut();
    ...
    pub fn reload_connections_async<'a, P: Into<Option<&'a gio::Cancellable>>, Q: FnOnce(Result<(), Error>) + Send + 'static>(&self, cancellable: P, callback: Q) {
        let cancellable = cancellable.into();
        let cancellable = cancellable.to_glib_none();
        let user_data: Box<Box<Q>> = Box::new(Box::new(callback));
    ...
    #[cfg(feature = "futures")]
    pub fn reload_connections_async_future(&self) -> Box_<futures_core::Future<Item = (Self, ()), Error = (Self, Error)>> {
        use gio::GioFuture;
        use send_cell::SendCell;
    ...
    pub fn save_hostname<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b gio::Cancellable>>>(&self, hostname: P, cancellable: Q) -> Result<(), Error> {
    ...
    pub fn save_hostname_async<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b gio::Cancellable>>, R: FnOnce(Result<(), Error>) + Send + 'static>(&self, hostname: P, cancellable: Q, callback: R) {
        let hostname = hostname.into();
        let hostname = hostname.to_glib_none();
        let cancellable = cancellable.into();
        let cancellable = cancellable.to_glib_none();
    ...
    #[cfg(feature = "futures")]
    pub fn save_hostname_async_future<'a, P: Into<Option<&'a str>>>(&self, hostname: P) -> Box_<futures_core::Future<Item = (Self, ()), Error = (Self, Error)>> {
        use gio::GioFuture;
        use send_cell::SendCell;
    ...
    pub fn set_logging<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b str>>>(&self, level: P, domains: Q) -> Result<(), Error> {
    ...
    pub fn connect_active_connection_added<F: Fn(&Client, &ActiveConnection) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client, &ActiveConnection) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "active-connection-added",
                transmute(active_connection_added_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_active_connection_removed<F: Fn(&Client, &ActiveConnection) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client, &ActiveConnection) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "active-connection-removed",
                transmute(active_connection_removed_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_any_device_added<F: Fn(&Client, &Device) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client, &Device) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "any-device-added",
                transmute(any_device_added_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_any_device_removed<F: Fn(&Client, &Device) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client, &Device) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "any-device-removed",
                transmute(any_device_removed_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_connection_added<F: Fn(&Client, &RemoteConnection) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client, &RemoteConnection) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "connection-added",
                transmute(connection_added_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_connection_removed<F: Fn(&Client, &RemoteConnection) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client, &RemoteConnection) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "connection-removed",
                transmute(connection_removed_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }
    ...
    pub fn connect_device_removed<F: Fn(&Client, &Device) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client, &Device) + 'static>> = Box_::new(Box_::new(f));
    ...
    pub fn connect_permission_changed<F: Fn(&Client, u32, u32) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client, u32, u32) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "permission-changed",
                transmute(permission_changed_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_activating_connection_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::activating-connection",
                transmute(notify_activating_connection_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_active_connections_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::active-connections",
                transmute(notify_active_connections_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_all_devices_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::all-devices",
                transmute(notify_all_devices_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_can_modify_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::can-modify",
                transmute(notify_can_modify_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_connections_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::connections",
                transmute(notify_connections_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_connectivity_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::connectivity",
                transmute(notify_connectivity_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_connectivity_check_available_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::connectivity-check-available",
                transmute(notify_connectivity_check_available_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_connectivity_check_enabled_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::connectivity-check-enabled",
                transmute(notify_connectivity_check_enabled_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_devices_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::devices",
                transmute(notify_devices_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    #[cfg(any(feature = "v1_6", feature = "dox"))]
    pub fn connect_property_dns_configuration_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::dns-configuration",
                transmute(notify_dns_configuration_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    #[cfg(any(feature = "v1_6", feature = "dox"))]
    pub fn connect_property_dns_mode_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::dns-mode",
                transmute(notify_dns_mode_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    #[cfg(any(feature = "v1_6", feature = "dox"))]
    pub fn connect_property_dns_rc_manager_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::dns-rc-manager",
                transmute(notify_dns_rc_manager_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_hostname_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::hostname",
                transmute(notify_hostname_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_metered_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
    ...
    pub fn connect_property_networking_enabled_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::networking-enabled",
                transmute(notify_networking_enabled_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_nm_running_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::nm-running",
                transmute(notify_nm_running_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_primary_connection_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::primary-connection",
                transmute(notify_primary_connection_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_startup_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::startup",
                transmute(notify_startup_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }
    ...
    pub fn connect_property_version_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::version",
                transmute(notify_version_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_wimax_enabled_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::wimax-enabled",
                transmute(notify_wimax_enabled_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_wimax_hardware_enabled_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::wimax-hardware-enabled",
                transmute(notify_wimax_hardware_enabled_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_wireless_enabled_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::wireless-enabled",
                transmute(notify_wireless_enabled_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_wireless_hardware_enabled_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::wireless-hardware-enabled",
                transmute(notify_wireless_hardware_enabled_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_wwan_enabled_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::wwan-enabled",
                transmute(notify_wwan_enabled_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }

    pub fn connect_property_wwan_hardware_enabled_notify<F: Fn(&Client) + 'static>(&self, f: F) -> SignalHandlerId {
        unsafe {
            let f: Box_<Box_<Fn(&Client) + 'static>> = Box_::new(Box_::new(f));
            connect(self.to_glib_none().0, "notify::wwan-hardware-enabled",
                transmute(notify_wwan_hardware_enabled_trampoline as usize), Box_::into_raw(f) as *mut _)
        }
    }
}

unsafe extern "C" fn active_connection_added_trampoline(this: *mut ffi::NMClient, active_connection: *mut ffi::NMActiveConnection, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client, &ActiveConnection) + 'static) = transmute(f);
    f(&from_glib_borrow(this), &from_glib_borrow(active_connection))
}

unsafe extern "C" fn active_connection_removed_trampoline(this: *mut ffi::NMClient, active_connection: *mut ffi::NMActiveConnection, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client, &ActiveConnection) + 'static) = transmute(f);
    f(&from_glib_borrow(this), &from_glib_borrow(active_connection))
}

unsafe extern "C" fn any_device_added_trampoline(this: *mut ffi::NMClient, device: *mut ffi::NMDevice, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client, &Device) + 'static) = transmute(f);
    f(&from_glib_borrow(this), &from_glib_borrow(device))
}

unsafe extern "C" fn any_device_removed_trampoline(this: *mut ffi::NMClient, device: *mut ffi::NMDevice, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client, &Device) + 'static) = transmute(f);
    f(&from_glib_borrow(this), &from_glib_borrow(device))
}

unsafe extern "C" fn connection_added_trampoline(this: *mut ffi::NMClient, connection: *mut ffi::NMRemoteConnection, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client, &RemoteConnection) + 'static) = transmute(f);
    f(&from_glib_borrow(this), &from_glib_borrow(connection))
}

unsafe extern "C" fn connection_removed_trampoline(this: *mut ffi::NMClient, connection: *mut ffi::NMRemoteConnection, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client, &RemoteConnection) + 'static) = transmute(f);
    f(&from_glib_borrow(this), &from_glib_borrow(connection))
}

unsafe extern "C" fn device_added_trampoline(this: *mut ffi::NMClient, device: *mut ffi::NMDevice, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client, &Device) + 'static) = transmute(f);
    f(&from_glib_borrow(this), &from_glib_borrow(device))
}

unsafe extern "C" fn device_removed_trampoline(this: *mut ffi::NMClient, device: *mut ffi::NMDevice, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client, &Device) + 'static) = transmute(f);
    f(&from_glib_borrow(this), &from_glib_borrow(device))
}

unsafe extern "C" fn permission_changed_trampoline(this: *mut ffi::NMClient, permission: libc::c_uint, result: libc::c_uint, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client, u32, u32) + 'static) = transmute(f);
    f(&from_glib_borrow(this), permission, result)
}

unsafe extern "C" fn notify_activating_connection_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_active_connections_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_all_devices_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_can_modify_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_connections_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_connectivity_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_connectivity_check_available_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_connectivity_check_enabled_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_devices_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

#[cfg(any(feature = "v1_6", feature = "dox"))]
unsafe extern "C" fn notify_dns_configuration_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

#[cfg(any(feature = "v1_6", feature = "dox"))]
unsafe extern "C" fn notify_dns_mode_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

#[cfg(any(feature = "v1_6", feature = "dox"))]
unsafe extern "C" fn notify_dns_rc_manager_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_hostname_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_metered_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_networking_enabled_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_nm_running_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_primary_connection_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_startup_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_state_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_version_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_wimax_enabled_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_wimax_hardware_enabled_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_wireless_enabled_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_wireless_hardware_enabled_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_wwan_enabled_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}

unsafe extern "C" fn notify_wwan_hardware_enabled_trampoline(this: *mut ffi::NMClient, _param_spec: glib_ffi::gpointer, f: glib_ffi::gpointer) {
    let f: &&(Fn(&Client) + 'static) = transmute(f);
    f(&from_glib_borrow(this))
}
