...
//pub fn utils_ap_mode_security_valid(type_: /*Ignored*/UtilsSecurityType, wifi_caps: DeviceWifiCapabilities) -> bool {
//    unsafe { TODO: call ffi::nm_utils_ap_mode_security_valid() }
//}

pub fn utils_bin2hexstr(src: &[u8], final_len: i32) -> Option<String> {
...
pub fn utils_check_virtual_device_compatibility(virtual_type: glib::types::Type, other_type: glib::types::Type) -> bool {
    unsafe {
        from_glib(ffi::nm_utils_check_virtual_device_compatibility(virtual_type.to_glib(), other_type.to_glib()))
    }
}
...
pub fn utils_enum_from_str(type_: glib::types::Type, str: &str) -> Option<(i32, String)> {
    unsafe {
        ...
        let ret = from_glib(ffi::nm_utils_enum_from_str(type_.to_glib(), str.to_glib_none().0, &mut out_value, &mut err_token));
        if ret { Some((out_value, from_glib_full(err_token))) } else { None }
    }
}

pub fn utils_enum_get_values(type_: glib::types::Type, from: i32, to: i32) -> Vec<String> {
    unsafe {
        FromGlibPtrContainer::from_glib_container(ffi::nm_utils_enum_get_values(type_.to_glib(), from, to))
    }
}

pub fn utils_enum_to_str(type_: glib::types::Type, value: i32) -> Option<String> {
    unsafe {
        from_glib_full(ffi::nm_utils_enum_to_str(type_.to_glib(), value))
    }
}
...
pub fn utils_file_is_private_key(filename: &str) -> Option<bool> {
    unsafe {
        ...
        let ret = from_glib(ffi::nm_utils_file_is_private_key(filename.to_glib_none().0, &mut out_encrypted));
        if ret { Some(from_glib(out_encrypted)) } else { None }
    }
}

//pub fn utils_file_search_in_paths<'a, 'b, P: Into<Option<&'a str>>, Q: Into<Option<&'b str>>, R: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(progname: &str, try_first: P, paths: Q, file_test_flags: /*Ignored*/glib::FileTest, predicate: /*Unknown conversion*//*Unimplemented*/UtilsFileSearchInPathsPredicate, user_data: R) -> Result<String, Error> {
...
pub fn utils_hexstr2bin(hex: &str) -> Option<glib::Bytes> {
    unsafe {
        from_glib_full(ffi::nm_utils_hexstr2bin(hex.to_glib_none().0))
    }
}
...
//pub fn utils_hwaddr_aton<P: Into<Option</*Unimplemented*/Fundamental: Pointer>>>(asc: &str, buffer: P, length: usize) -> u8 {
//    unsafe { TODO: call ffi::nm_utils_hwaddr_aton() }
//}
...
pub fn utils_hwaddr_ntoa(addr: &[u8]) -> Option<String> {
    let length = addr.len() as usize;
    unsafe {
...
pub fn utils_inet4_ntop(inaddr: &str, dst: &str) -> Option<String> {
    unsafe {
        from_glib_none(ffi::nm_utils_inet4_ntop(inaddr.to_glib_none().0, dst.to_glib_none().0))
    }
}

//pub fn utils_ip4_addresses_from_variant(value: &glib::Variant) -> (/*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 134 }, String) {
//    unsafe { TODO: call ffi::nm_utils_ip4_addresses_from_variant() }
//}

//pub fn utils_ip4_addresses_to_variant<'a, P: Into<Option<&'a str>>>(addresses: /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 134 }, gateway: P) -> Option<glib::Variant> {
//    unsafe { TODO: call ffi::nm_utils_ip4_addresses_to_variant() }
//}

pub fn utils_ip4_dns_to_variant(dns: &str) -> Option<glib::Variant> {
    unsafe {
        from_glib_none(ffi::nm_utils_ip4_dns_to_variant(dns.to_glib_none().0))
    }
}
...
//pub fn utils_ip4_routes_from_variant(value: &glib::Variant) -> /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 135 } {
//    unsafe { TODO: call ffi::nm_utils_ip4_routes_from_variant() }
//}

//pub fn utils_ip4_routes_to_variant(routes: /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 135 }) -> Option<glib::Variant> {
//    unsafe { TODO: call ffi::nm_utils_ip4_routes_to_variant() }
//}

//pub fn utils_ip6_addresses_from_variant(value: &glib::Variant) -> (/*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 134 }, String) {
//    unsafe { TODO: call ffi::nm_utils_ip6_addresses_from_variant() }
//}

//pub fn utils_ip6_addresses_to_variant<'a, P: Into<Option<&'a str>>>(addresses: /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 134 }, gateway: P) -> Option<glib::Variant> {
//    unsafe { TODO: call ffi::nm_utils_ip6_addresses_to_variant() }
//}

pub fn utils_ip6_dns_from_variant(value: &glib::Variant) -> Option<String> {
    unsafe {
        from_glib_full(ffi::nm_utils_ip6_dns_from_variant(value.to_glib_none().0))
    }
}

pub fn utils_ip6_dns_to_variant(dns: &str) -> Option<glib::Variant> {
    unsafe {
        from_glib_none(ffi::nm_utils_ip6_dns_to_variant(dns.to_glib_none().0))
    }
}

//pub fn utils_ip6_routes_from_variant(value: &glib::Variant) -> /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 135 } {
//    unsafe { TODO: call ffi::nm_utils_ip6_routes_from_variant() }
//}

//pub fn utils_ip6_routes_to_variant(routes: /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 135 }) -> Option<glib::Variant> {
//    unsafe { TODO: call ffi::nm_utils_ip6_routes_to_variant() }
//}

//pub fn utils_ip_addresses_from_variant(value: &glib::Variant, family: i32) -> /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 134 } {
//    unsafe { TODO: call ffi::nm_utils_ip_addresses_from_variant() }
//}

//pub fn utils_ip_addresses_to_variant(addresses: /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 134 }) -> Option<glib::Variant> {
//    unsafe { TODO: call ffi::nm_utils_ip_addresses_to_variant() }
//}

//pub fn utils_ip_routes_from_variant(value: &glib::Variant, family: i32) -> /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 135 } {
//    unsafe { TODO: call ffi::nm_utils_ip_routes_from_variant() }
//}

//pub fn utils_ip_routes_to_variant(routes: /*Unknown conversion*//*Unimplemented*/PtrArray TypeId { ns_id: 1, id: 135 }) -> Option<glib::Variant> {
...
//pub fn utils_parse_variant_attributes(string: &str, attr_separator: glib::Char, key_value_separator: glib::Char, ignore_unknown: bool, spec: /*Ignored*/&VariantAttributeSpec) -> Result</*Unknown conversion*//*Unimplemented*/HashTable TypeId { ns_id: 0, id: 25 }/TypeId { ns_id: 0, id: 25 }, Error> {
...
pub fn utils_same_ssid(ssid1: &[u8], ssid2: &[u8], ignore_trailing_null: bool) -> bool {
    ...
    unsafe {
        from_glib(ffi::nm_utils_same_ssid(ssid1.to_glib_none().0, len1, ssid2.to_glib_none().0, len2, ignore_trailing_null.to_glib()))
    }
}

//pub fn utils_security_valid(type_: /*Ignored*/UtilsSecurityType, wifi_caps: DeviceWifiCapabilities, have_ap: bool, adhoc: bool, ap_flags: /*Ignored*/80211ApFlags, ap_wpa: /*Ignored*/80211ApSecurityFlags, ap_rsn: /*Ignored*/80211ApSecurityFlags) -> bool {
//    unsafe { TODO: call ffi::nm_utils_security_valid() }
//}
...
//pub fn utils_wep_key_valid(key: &str, wep_type: /*Ignored*/WepKeyType) -> bool {
//    unsafe { TODO: call ffi::nm_utils_wep_key_valid() }
//}
