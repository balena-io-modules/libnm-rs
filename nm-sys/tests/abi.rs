...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) NM_CLIENT_PERMISSION_LAST", "16"),
    ...
    ("(gint) NM_SETTING_DIFF_RESULT_IN_B_DEFAULT", "4"),
    ...
    ("(gint) NM_SETTING_WIRELESS_SECURITY_WPS_METHOD_AUTO", "2"),
    ("(gint) NM_SETTING_WIRELESS_SECURITY_WPS_METHOD_DEFAULT", "0"),
    ("(gint) NM_SETTING_WIRELESS_SECURITY_WPS_METHOD_DISABLED", "1"),
    ("(gint) NM_SETTING_WIRELESS_SECURITY_WPS_METHOD_PBC", "4"),
    ("(gint) NM_SETTING_WIRELESS_SECURITY_WPS_METHOD_PIN", "8"),
